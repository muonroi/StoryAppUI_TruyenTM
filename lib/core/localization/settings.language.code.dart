...
//View all
  viewAllTextInfo,
//New stories updated
  newUpdatedStoriesTextInfo,
//Common of stories
  commonOfStoriesTextInfo,
//Common stories of all
  allCommonStoriesTextInfo,
//Common stories of the day
  commonStoriesOfDayTextInfo,
//Common stories of the month
  commonStoriesOfMonthTextInfo,
...
// Custom another dashboard(font,color)
  ...
  buyNowTextInfo,
  monthTextInfo,
  customerBenefitsTextInfo,
  oneLawsUpgradeAccountTextInfo,
  logoutAccountTextInfo,
  contactTextInfo,
  contactToEmailTextInfo,
  askCommonTextInfo,
  privacyTextInfo,
  privacyTermsTextInfo,
  followUserTextInfo,
  inboxTextInfo,
  gmailUserTextInfo,
  phoneNumberTextInfo,
  birthdayUserTextInfo,
  addressUserTextInfo,
  themeModeTextInfo,
  lightModeTextInfo,
  darkModeTextInfo,
  ...
  languageTextInfo,
  continueWithGoogleTextInfo,
  emailSignUpTextInfo,
  usernameSignUpErrorTextInfo,
  emailSignUpErrorTextInfo,
  serverErrorReLoginTextInfo,
  haveAccountTextInfo,
  chosseGenderTextInfo,
  maleTextInfo,
  femaleTextInfo,
  requestDeleteAccountTextInfo,
  confirmDeleteAccountTextInfo,
  privacyDeleteAccountTextInfo,
  privacyOneTextInfo,
  privacyTwoTextInfo,
  privacyThirdTextInfo,
  privacyFourTextInfo,
  privacyFiveTextInfo,
  privacySixTextInfo,
  privacySevenTextInfo,
