...
class LocalizationLib {
  static final Map<String, Map<String, String>> _localizedValues = {
    Languages.en: {},
    Languages.vi: {
      LanguageCodes.searchTextInfo.toString(): 'Tìm kiếm truyện',
      LanguageCodes.notfoundTextInfo.toString(): 'Không xác định',
      LanguageCodes.genreOfStrTextInfo.toString(): 'Thể loại',
      LanguageCodes.translateStrTextInfo.toString(): 'Truyện dịch',
      LanguageCodes.creationStrTextInfo.toString(): 'Sáng tác',
      LanguageCodes.fullStrTextInfo.toString(): 'Truyện full',
      LanguageCodes.editorChoiceTextInfo.toString(): 'Lựa chọn biên tập viên',
